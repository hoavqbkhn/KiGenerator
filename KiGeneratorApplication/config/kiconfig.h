...
class KiConfig
{
    public:
        ...
        int getDisQuaterD() const;
        void setDisQuaterD(int disQuaterD);

        int getDisQuaterA() const;
        void setDisQuaterA(int disQuaterA);

        int getDisMonthD() const;
        void setDisMonthD(int disMonthD);
